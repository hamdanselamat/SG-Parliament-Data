...
seats = [79,14,12,2]  # Must sum to total seats
colors = ["#B81111", "#106c10", "#0759dc", '#ff7f0e']
...
ax.legend(loc='lower center', bbox_to_anchor=(0.5, -0.1), ncol=4, frameon=False)

ax.set_aspect('equal')
ax.axis('off')
plt.title('Distribution By Ethnicity', fontsize=14, fontweight='bold', pad=20)
plt.show()